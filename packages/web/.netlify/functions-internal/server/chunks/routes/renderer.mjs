...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Automated schema analysis, parity verification, and migration reporting for Strapi v3 to v5 migrations."},{"property":"og:title","content":"StrapiShift — Strapi v3 → v5 Migration Platform"},{"property":"og:description","content":"Automated schema analysis, parity verification, and migration reporting for Strapi v3 to v5 migrations."},{"property":"og:image","content":"/og-image.png"},{"property":"og:type","content":"website"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:title","content":"StrapiShift — Strapi v3 → v5 Migration Platform"},{"name":"twitter:description","content":"Automated schema analysis, parity verification, and migration reporting for Strapi v3 to v5 migrations."},{"name":"twitter:image","content":"/og-image.png"}],"link":[],"style":[],"script":[],"noscript":[],"title":"StrapiShift — Strapi v3 → v5 Migration Platform","htmlAttrs":{"lang":"en"}};
